export const seedData = {
  ...
  homePage: {
    ...
    marqueeLogos: [
      { name: "TVS", logo: "/figma-assets/marquee-tvs.png" },
      { name: "Honda", logo: "/figma-assets/marquee-honda.png" },
      { name: "Royal Enfield", logo: "/figma-assets/marquee-royal-enfield.png" },
      { name: "IHCL", logo: "/figma-assets/marquee-ihcl-1.png" },
      { name: "MG", logo: "/figma-assets/marquee-mg.png" },
      { name: "Tata", logo: "/figma-assets/marquee-tata1.png" },
    ],
    heroPartners: [
      {
        title: "WTIIRA",
  ...
  vehicleWashingPage: {
    ...
    features: [
      ...
      { icon: "/vehicle-assets/feature-2.svg", description: "Express tunnel wash for high-volume throughput at busy locations" },
      ...
      { icon: "/vehicle-assets/feature-5.svg", description: "IoT-enabled wash data flowing into the ESG dashboard" },
      { icon: "/vehicle-assets/feature-6.svg", description: "Zero capex model available through Pay-per-Wash and WaaS" },
    ],
    ...
    businessModels: [
      ...
      { icon: "/vehicle-assets/business-2.svg", title: "Wash-as-a-Service (WaaS)", description: "Revenue-share or subscription model with zero upfront capex" },
