      ...
      <div className="mx-auto max-w-[1650px]">
        <div className="grid gap-10 xl:grid-cols-[1.05fr_.95fr] xl:items-center">
          <div className="relative overflow-hidden rounded-[18px] xl:rounded-none">
            <div className="pointer-events-none absolute inset-y-0 right-0 z-10 hidden w-28 bg-gradient-to-r from-transparent to-white xl:block" />
            <Image
          ...
          <div className="max-w-[810px] xl:pl-[18px]">
            ...
            <h1 className="mt-2 font-heading text-[42px] leading-[1.05] font-bold text-brand-navy md:text-[50px] xl:text-[55px]">
              Enabling Water Security —
              <br />
              Decentralised, at Scale
            </h1>
            <p className="mt-[30px] text-[20px] leading-[1.4] text-brand-muted md:text-[22px] md:leading-[1.405]">
