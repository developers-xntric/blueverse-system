...
function SystemFeatures() {
  return (
    <MotionSection
      id="vehicle-washing"
      className="border-b border-[#dfdfdf]  py-8 md:py-[70px]"
    >
          ...
          {washTypes.map(([title, description]) => (
            ...
            >
              ...
              <div className="flex flex-col items-center gap-[15px]">
                <h3 className="font-heading text-[20px] leading-[24px] md:text-[24.227px] font-bold md:leading-[33.918px] text-brand-navy">{title}</h3>
                <p className="text-[15px] leading-[20px] md:text-[16px] md:leading-[22.2px] text-brand-soft">{description}</p>
              </div>
            </motion.article>
          ))}
        </div>
          ...
          {businessModels.map(([icon, title, description]) => (
            ...
            >
              ...
              <div className="flex w-full flex-col items-center gap-4">
                <h3 className="font-heading text-[20px] leading-[25px] md:text-[24.227px] font-bold md:leading-[33.918px] text-brand-navy">{title}</h3>
                <p className="text-[15px] leading-[20px] md:text-[16px] md:leading-[22.2px] text-brand-muted">{description}</p>
              </div>
            </motion.article>
          ))}
        </div>
...
function RegionalCtas() {
  return (
    <MotionSection
      id="regions"
      className="relative z-0  py-[40px] text-white  md:pb-[77px] md:pt-[78px]"
    >
      <div
          ...
          >
            <div className="flex w-full flex-1 flex-col items-center gap-[30px] ">
              ...
              <div className="flex flex-col items-center gap-[10px]">
                ...
                <p className="max-w-[729px] text-[15px] leading-[20px] md:text-[16.959px] leading-[24.227px]">{copy}</p>
              </div>
