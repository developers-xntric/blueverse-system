  ...
  return (
    <section className=" py-6 md:py-[45px]">
      <div className="homepage-shell rounded-[18px] ">
        <div className="rounded-[20px] bg-[#E8F4FD] px-4 md:px-6 py-8 md:px-[51px] md:py-[55px]">
