...
export function LeafIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M16.5537 30.0972C13.9113 30.1052 11.3623 29.1198 9.41245 27.3364C7.46255 25.553 6.25413 23.1019 6.02685 20.4693C5.79957 17.8366 6.57004 15.2147 8.18544 13.1235C9.80084 11.0323 12.1432 9.62466 14.7479 9.17967C23.3256 7.52433 25.5828 6.74181 28.5926 3.00977C30.0974 6.01948 31.6023 9.30006 31.6023 15.0486C31.6023 23.3253 24.4091 30.0972 16.5537 30.0972Z" />
      <path d="M3.00977 31.6018C3.00977 27.0872 5.79375 23.5358 10.6544 22.5727C14.2962 21.8503 18.0583 19.563 19.5632 18.0581" />
    </svg>
  );
}
