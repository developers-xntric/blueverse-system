...
export const fallbackNavLinks: NavLink[] = [
  { label: "Home", href: "/" },
...
export const fallbackHeroPartners: Partner[] = [
  {
    title: "WTIIRA",
...
export const fallbackAboutTabs: AboutTab[] = [
  {
    name: "Our Values",
    panel: {
  ...
  },
  {
    ...
    panel: {
      ...
      timeline: [
        {
          year: "2021",
          description: "Developed and patented automated 2-wheeler vehicle washing machine",
        },
        {
          year: "2022",
          description: "Built proprietary ESG Tech Stack for water metrics in vehicle washing",
        },
        {
          year: "2024",
          description: "Expanded to 15 operational sites across India; entered the UAE market",
        },
        {
          year: "2025",
        ...
        {
          year: "2026",
          description: "Incubated in WTIIRA Saudi Water Authority innovation programme",
        },
        {
          year: "2026",
          description: "Selected for WaterTech Accelerator QSTP × TotalEnergies, Qatar",
        },
      ],
    },
  },
...
export const fallbackPartners: Partnership[] = [
  {
    name: "MCWW",
...
export const fallbackDeploymentHighlights: string[] = [
...
export const fallbackFooterServiceLinks: string[] = [
